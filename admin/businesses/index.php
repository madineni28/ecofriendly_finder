...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		<title>Businesses :: EcoFriendly</title>
                      ...
                      <tbody>
						<?php
							...
							foreach($businesses as $row) {
										...
										$i++;
						?>
                        <tr id="deal_id<?php echo $business_id; ?>">
                          <td class="product-thumbnail">
                            <img src="<?php echo $path; ?>images/businesses/<?php echo $image_url; ?>" alt="Image" class="img-fluid">
                          </td>
                          ...
                          <td><a class="btn btn-black btn-sm" onclick="remove_from_business(<?php echo $business_id ; ?>)">X</a></td>
						  <td><a class="btn btn-black btn-sm" onclick="edit_deal(<?php echo $business_id ; ?>)">Edit</a></td>
                        </tr>
							<?php 
